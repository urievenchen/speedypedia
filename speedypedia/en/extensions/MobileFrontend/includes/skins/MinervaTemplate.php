	...
	protected function renderFooter( $data ) {
		...
		<div id="footer">
			...
			<div class="main-footer">
				<ul>
					<li>
						<a href="http://www.speedypedia.info/" title="Speedypedia">Speedypedia</a>
					</li>
					<li>
						<a href="http://en.speedy.net/blog/" title="Speedy Net Blog">Speedy Net Blog</a>
					</li>
				</ul>
				<ul>
					<li>
						<a href="http://www.cafepress.com/speedypedia" title="Speedypedia's Shop">Speedypedia's Shop</a>
					</li>
					<li>
						<a href="http://www.cafepress.com/speedy_s" title="Speedy S-logo Shop">Speedy S-logo Shop</a>
					</li>
				</ul>
				<ul>
					<li>
				...
				<div class="speedy-image">
					<!-- Facebook Badge START --><a href="https://www.facebook.com/speedyevenchen" target="_top" style="font-family: &quot;lucida grande&quot;,tahoma,verdana,arial,sans-serif; font-size: 11px; font-variant: normal; font-style: normal; font-weight: normal; color: #3B5998; text-decoration: none;" title="Speedy">Speedy</a><br/><a href="https://www.facebook.com/speedyevenchen" target="_top" title="Speedy"><img class="fb-badge" src="https://badge.facebook.com/badge/110275029046282.1598.135831057.png" style="border: 0px;" /></a><br/><!-- Facebook Badge END -->
				</div>
			</div>
		</div>
	...
	protected function render( $data ) {
		...
		<div id="mw-mf-viewport">
			...
			<div id="mw-mf-page-center">
				<img class="top-logo" src="/resources/assets/speedypedia/speedypedia_en_logo_2a.png" />
				<?php
